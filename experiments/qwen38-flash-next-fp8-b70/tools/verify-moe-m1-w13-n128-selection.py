#!/usr/bin/env python3
"""Verify the default-off M1 W13-N128 tuned-map integration.

This helper performs no inference.  It binds the candidate map to the retained
M1 map, verifies that their sole semantic difference is the nested W13 N128
...
EXPECTED_CANDIDATE_CONFIG_SHA256 = (
    "8b67485c1ad13ea3b1b0ebdb06a6a2d0e18bd4b9058f44a2378c4a47d0f41315"
)
...
def validate_maps(
    ...
    if candidate[1].get("W1_CONFIG") != W13_DELTA:
        raise IntegrationContractError("key 1 lacks the exact W13 N128 delta")
    ...
    if flattened_m1 != base[1]:
        raise IntegrationContractError("key 1 changes fields beyond W13 N128")
...
def build_receipt(
    ...
    return {
        "schema_version": 1,
        "status": "pass",
        "classification": "qwen38_m1_w13_n128_static_integration_receipt",
