#!/usr/bin/env python3
"""Verify the default-off M1 W13-N64 tuned-map integration.

This helper performs no inference.  It binds the candidate map to the retained
M1 map, verifies that their sole semantic difference is the nested W13 N64
...
EXPECTED_CANDIDATE_CONFIG_SHA256 = (
    "4fcb5d13ef0c859d12a4fe6b5aac09b04fccf4db24e47a6f004d3f9878e4e38f"
)
...
def validate_maps(
    ...
    if candidate[1].get("W1_CONFIG") != W13_DELTA:
        raise IntegrationContractError("key 1 lacks the exact W13 N64 delta")
    ...
    if flattened_m1 != base[1]:
        raise IntegrationContractError("key 1 changes fields beyond W13 N64")
...
def build_receipt(
    ...
    return {
        "schema_version": 1,
        "status": "pass",
        "classification": "qwen38_m1_w13_n64_static_integration_receipt",
