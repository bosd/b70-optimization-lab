...
| --- | --- | --- | --- | --- |
| [Qwen3.8 FP8 prefill/decode classifier fix](dominick253-qwen38-27b-fp8-uniform-decode-alias/STATUS.md) | [dominick253](https://github.com/dominick253); upstream fix by [allenzz-dev](https://github.com/allenzz-dev) | [PR #45](https://github.com/steveseguin/b70-optimization-lab/pull/45) | `community-reported` incident | Actual R50 classifier: 15 CPU cases before/after on both source copies; separate patched image built; GPU incident and soak unverified |
