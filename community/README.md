...
| --- | --- | --- | --- | --- |
| [Qwen3.8 FP8 prefill/decode classifier fix](dominick253-qwen38-27b-fp8-uniform-decode-alias/STATUS.md) | [dominick253](https://github.com/dominick253); upstream fix by [allenzz-dev](https://github.com/allenzz-dev) | [PR #45](https://github.com/steveseguin/b70-optimization-lab/pull/45) | `community-reported` incident | Original classifier: 15 CPU cases/copy, local tiny-screen failure remains. Separate maintainer GDN phase guard: 120/120 probes and two fresh compiled 12/12 normal-suite comparisons pass; multi-hour incident unverified |
