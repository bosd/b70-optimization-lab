...
| **[Qwen3.5 9B FP8-dynamic with its own MTP head on one Intel Arc Pro B70](models/qwen35-9b-fp8-b70.html)**<br>1&times; B70 · FP8-dynamic (compressed-tensors, per-channel FP8 weights, dynamic activations) · vLLM XPU | `candidate` · clean-host replay pending | **`76.898 tok/s`**<br>MTP depth 3 decode, one card, strict completions suite (center of two fresh servers, 76.917 / 76.879) | [reproduction guide](repro/qwen35-9b-fp8-b70/README.md) |
