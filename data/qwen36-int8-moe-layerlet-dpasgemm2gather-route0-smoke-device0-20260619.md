...
- Mean `xpu_fused_moe`: `333.883 us`.
- Mean scratch `xpu_fused_moe`: `255.908 us`.
- Mean preallocated staged: `209.455 us`.
- Mean fused-prologue staged: `290.318 us`.
- Mean full C++ layerlet: `176.817 us`.
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | 0 | 8 | 333.883 | 255.908 | 209.455 | 290.318 | n/a | n/a | n/a | 176.817 | 102.035 | 98.002 | 175.502 |

## Prologue-Inclusive Gate

- Gate status: `exact_nonreference_candidates_exist_but_gate_not_met`.
- Rows ready for endpoint gate: `0` / `1`.
- Best exact non-reference full-layerlet candidate: `full_layerlet` at `176.817 us` (`1.888x` vs current `xpu_fused_moe`).
- Endpoint promotion allowed by this artifact: `False`.
- Endpoint promotion still requires graph-path tensor capture, accepted-lane quality gates, and a manifest update.

| rows | route start | best exact nonref | best nonref us | speedup vs xpu | target met | status |
|---:|---:|---|---:|---:|---:|---|
| 1 | 0 | full_layerlet | 176.817 | 1.888 | False | best_exact_nonreference_misses_target_layerlet_us |
