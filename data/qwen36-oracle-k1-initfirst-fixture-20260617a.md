...
- Candidate: `/home/steve/llm-optimizations/data/qwen36-oracle-k1-initfirst-candidate-20260617a.json`
...
- Replay mapping: `mapped`
  - Request: `cmpl-initfirst20260617a-000000-0-88659ca7`
  - Trace row: `4`
  - Position in row: `0`
...
Intel XPU decode`
- Replay mapping: `mapped`
  - Request: `cmpl-initfirst20260617a-000001-0-92fa674b`
  - Trace row: `6`
  - Position in row: `0`
  - Emission role: `replacement_after_reject`
  - Scheduled: `[78503]`
