...
- Candidate: `/home/steve/llm-optimizations/data/qwen36-oracle-k1-stateidx-smallgraph-candidate-20260617a.json`
...
- Replay mapping: `mapped`
  - Request: `cmpl-stateidx-a-000000-0-90e5db49`
  - Trace row: `9`
  - Position in row: `0`
...
Intel XPU decode`
- Replay mapping: `mapped`
  - Request: `cmpl-stateidx-a-000001-0-bb7adb8b`
  - Trace row: `15`
  - Position in row: `1`
