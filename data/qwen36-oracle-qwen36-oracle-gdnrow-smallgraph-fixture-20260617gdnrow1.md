...
- Candidate: `/home/steve/llm-optimizations/data/qwen36-oracle-k1-gdnrow-smallgraph-candidate-20260617a.json`
...
- Replay mapping: `mapped`
  - Request: `cmpl-gdnrow-a-000000-0-bbb4fdc6`
  - Trace row: `9`
  - Position in row: `0`
...
Intel XPU decode`
- Replay mapping: `mapped`
  - Request: `cmpl-gdnrow-a-000001-0-b2bd2c4a`
  - Trace row: `15`
  - Position in row: `1`
