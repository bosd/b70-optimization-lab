...
- Candidate: `/home/steve/llm-optimizations/data/qwen36-oracle-k1-recoverrepl-candidate-20260617a.json`
...
- Replay mapping: `mapped`
  - Request: `cmpl-recoverrepl20260617a-000000-0-ade6efc0`
  - Trace row: `9`
  - Position in row: `0`
...
Intel XPU decode`
- Replay mapping: `mapped`
  - Request: `cmpl-recoverrepl20260617a-000001-0-93ca264d`
  - Trace row: `15`
  - Position in row: `1`
