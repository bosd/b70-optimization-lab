...
- Candidate: `/home/steve/llm-optimizations/data/qwen36-oracle-k1-fullbonus-smallgraph-candidate-20260617a.json`
...
- Replay mapping: `mapped`
  - Request: `cmpl-fullbonus20260617a-000000-0-ba9ce8d7`
  - Trace row: `9`
  - Position in row: `0`
...
Intel XPU decode`
- Replay mapping: `mapped`
  - Request: `cmpl-fullbonus20260617a-000001-0-96948e89`
  - Trace row: `15`
  - Position in row: `1`
