...
- Mean `xpu_fused_moe`: `327.063 us`.
- Mean scratch `xpu_fused_moe`: `283.573 us`.
- Mean prologue-scratch `xpu_fused_moe`: `303.819 us`.
- Mean preallocated staged: `234.381 us`.
- Mean fused-prologue staged: `280.679 us`.
- Mean fused-prologue offset-GEMM staged: `205.452 us`.
- Mean fused-prologue active-offset-GEMM staged: `250.865 us`.
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | 80 | 8 | 327.063 | 283.573 | 303.819 | 234.381 | 280.679 | 205.452 | 250.865 | n/a | n/a | 92.664 | 93.340 | 163.211 |

## Prologue-Inclusive Gate

- Gate status: `exact_nonreference_candidates_exist_but_gate_not_met`.
- Rows ready for endpoint gate: `0` / `1`.
- Best exact non-reference full-layerlet candidate: `fused_prologue_offset_gemm` at `205.452 us` (`1.592x` vs current `xpu_fused_moe`).
- Endpoint promotion allowed by this artifact: `False`.
- Endpoint promotion still requires graph-path tensor capture, accepted-lane quality gates, and a manifest update.

| rows | route start | best exact nonref | best nonref us | speedup vs xpu | target met | status |
|---:|---:|---|---:|---:|---:|---|
| 1 | 80 | fused_prologue_offset_gemm | 205.452 | 1.592 | False | best_exact_nonreference_misses_target_layerlet_us |
