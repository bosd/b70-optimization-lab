...
| Qwen3.5 4B W4A16, MTP3 + draft INT4 head | 1-2x Arc Pro B70 | **236.916 median tok/s on two cards** (mean of all four two-card servers; one-card lane `177.287`), fixed cold realistic gate, lossless against a same-configuration MTP0 oracle | [`cmtrycz0y002pps011142ifrk`](https://www.localmaxxing.com/runs/cmtrycz0y002pps011142ifrk), [`cmtrj2tp3000hps01n3fadg9d`](https://www.localmaxxing.com/runs/cmtrj2tp3000hps01n3fadg9d) | [packet](../packages/qwen35-4b-w4a16-b70/README.md); [repro](../repro/qwen35-4b-w4a16-b70/README.md) |
| Qwen3.5 9B W4A16, MTP3 + draft INT4 head | 1-2x Arc Pro B70 | **172.296 median tok/s on two cards** (one-card lane `113.265`), fixed cold realistic gate, lossless; the one-card route is byte-exact at every concurrency through 64 users where the FP8 build is not | [`cmtrn9hoy001ops01qzd4axry`](https://www.localmaxxing.com/runs/cmtrn9hoy001ops01qzd4axry), [`cmtrhoyl1000cps01o43bhl72`](https://www.localmaxxing.com/runs/cmtrhoyl1000cps01o43bhl72) | [packet](../packages/qwen35-9b-w4a16-b70/README.md); [repro](../repro/qwen35-9b-w4a16-b70/README.md) |
| Qwen3.5 9B FP8-dynamic, MTP3 + draft INT4 head | 1-2x Arc Pro B70 | `147.801` median tok/s on two cards (one-card lane `98.139`), fixed cold realistic gate. Slower than the W4A16 build of the same model at every depth, and it flips a near-tie token from 16 concurrent users up, so W4A16 is the packaged route | [`cmtqzhlvn00c0pa0109xxfb2f`](https://www.localmaxxing.com/runs/cmtqzhlvn00c0pa0109xxfb2f), [`cmtqyanxc00bjpa01nojy87wp`](https://www.localmaxxing.com/runs/cmtqyanxc00bjpa01nojy87wp) | [packet](../packages/qwen35-9b-fp8-b70/README.md); [repro](../repro/qwen35-9b-fp8-b70/README.md) |
...
| `qwen35-4b-w4a16-tp2-mtp3-graph-drafthead-strict-237tok-20260908` | `cmtrycz0y002pps011142ifrk` | 1 | 56 | 512 | **236.916 median 1-100 after TTFT** (two B70s, TP2) | Four two-card depth-3 servers across campaigns t1 and t2: 240.615, 227.533, 240.158, 239.359. Three agree within 0.5% and one sits 5.4% low, so the submitted figure is the mean of all four rather than campaign t2's own pair (239.758) - t2 was run because t1's pair was too widely spread to submit, and quoting t2 alone would be selecting the better of two campaigns. Every campaign passed G1, G2 and both G3 comparisons 12/12, so it is lossless at either figure. The second card is worth +35% without speculation and +32% with it on this model |
