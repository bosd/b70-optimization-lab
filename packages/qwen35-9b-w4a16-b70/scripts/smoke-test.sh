...
# the strict suite: see repro/qwen35-9b-w4a16-b70/README.md for the measured gates.
#
...
echo "  OpenAI-compatible endpoint: http://127.0.0.1:${port}/v1  (model: qwen35-9b-w4a16)"
