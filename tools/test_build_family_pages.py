...
class FamilyCoverageTest(unittest.TestCase):
    ...
    def test_flash_next_practical_coverage_is_compact_exact_and_runtime_bound(self) -> None:
        ...
        self.assertEqual(
            practical_states,
            Counter({"lab-screened": 12, "quarantined": 13}),
        )
        ...
        mtp4_8k = practical["cells"]["4:8192"]
        self.assertEqual(mtp4_8k["state"], "quarantined")
        self.assertIn("token 27", mtp4_8k["label"])
        self.assertIn("4.026 tok/s diagnostic only", mtp4_8k["label"])
        self.assertNotIn("evidence_id", mtp4_8k)
        self.assertTrue(
            mtp4_8k["evidence"].endswith(
                "20260828-tp4-mtp4-8448-context-attempt2-parity-quarantine.json"
            )
        )
        ...
        mtp2_8k = practical["cells"]["2:8192"]
        self.assertEqual(mtp2_8k["state"], "quarantined")
        self.assertIn("token 27", mtp2_8k["label"])
        self.assertIn("diagnostic only", mtp2_8k["label"])
        self.assertNotIn("evidence_id", mtp2_8k)
        self.assertTrue(
            mtp2_8k["evidence"].endswith(
                "20260828-tp4-mtp2-8448-context-attempt2-parity-quarantine.json"
            )
        )
        ...
        mtp3_8k = practical["cells"]["3:8192"]
        self.assertEqual(mtp3_8k["state"], "quarantined")
        self.assertIn("900-second client timeout", mtp3_8k["label"])
        self.assertIn("no completed receipt or speed", mtp3_8k["label"])
        self.assertNotIn("evidence_id", mtp3_8k)
        self.assertTrue(
            mtp3_8k["evidence"].endswith(
        ...
        self.assertIn("all 25 practical", family["summary"])
        self.assertNotIn("remains blank", family["summary"])
        ...
        self.assertIn(
            "Observed: 900-second client timeout; no completed receipt or speed.",
            rendered,
        )
        self.assertIn(
            "Observed: exact 8K completed; parity mismatch at token 27; 4.026 tok/s diagnostic only.",
            rendered,
        )
        self.assertIn(
