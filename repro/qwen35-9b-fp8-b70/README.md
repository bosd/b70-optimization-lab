...
| 5 | INT4 draft copy | on | 91.301 / 91.294 | - | 12/12 | **8/12, 8/12** (withheld) | c9 |
| 6 | INT4 draft copy | on | 88.602 / 88.677 | - | 12/12 | **8/12, 8/12** (withheld) | c10 |
...
context ladder is below; the two-card ladder follows it.
