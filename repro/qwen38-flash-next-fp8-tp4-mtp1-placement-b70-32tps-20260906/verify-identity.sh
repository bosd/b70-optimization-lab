...
die() { printf 'placement MTP1 identity: %s\n' "$*" >&2; exit 2; }
...
[[ "$(git -C "$vllm_tree" rev-parse HEAD)" == 005dc57895896f770157ea94f68e473e7447139e ]] || die "vLLM tree is not checked out at 005dc578 (git checkout q38-placement-mtp1-005dc578)"
