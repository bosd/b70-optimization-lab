...
**Not built, not replayed** as of 2026-09-07. The `Dockerfile` (the lossless-MTP1 image plus the placement and Triton-HC overlay bundles and the never-routed expert placement file) and
