#!/usr/bin/env python3
"""Compare a replay's realistic-suite-v1-result.json with the A272 record.
...
is printed next to the record's 37.045844 tok/s. Speed is reported, not gated:
...
RECORD = HERE.parents[1] / "experiments/qwen38-flash-next-fp8-b70/data/20260907-tp4-mtp1-a272-realistic-suite-v1-result.json"
...
def main():
    ...
    print(f"replay class-balanced median: {med:.6f} tok/s (record 37.045844)")
